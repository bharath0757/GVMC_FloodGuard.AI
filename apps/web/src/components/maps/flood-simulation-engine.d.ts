...
export declare function initSimulation(mockWards: Array<{
    id: string;
    number: number;
    name: string;
    riskScore: number;
}>, rainfallMmHr?: number): SimulationState;
export declare function stepSimulation(state: SimulationState, dtMs: number): SimulationState;
export declare function resetSimulation(state: SimulationState): SimulationState;
