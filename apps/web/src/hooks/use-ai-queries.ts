...
const MOCK_DASHBOARD: DashboardSummary = {
  ...
  ward_predictions: [
    ...
    },
    {
      ...
      confidence: 0.91,
      rainfall_mm_hr: 71.3,
      water_level_cm: 158.0,
      model_used: 'XGBoost-v2.1',
      timestamp: new Date().toISOString(),
      top_factor: 'water_level_cm',
    },
    {
      ward_number: 1,
      ward_name: 'Old Town',
    ...
    {
      ward_number: 19,
      ward_name: 'Gopalapatnam',
      risk_score: 68.4,
      risk_category: 'High',
      alert_color: 'Orange',
      confidence: 0.85,
      rainfall_mm_hr: 57.6,
      water_level_cm: 112.0,
      model_used: 'XGBoost-v2.1',
      timestamp: new Date().toISOString(),
      top_factor: 'water_level_cm',
    },
    ...
    },
    {
      ...
      model_used: 'XGBoost-v2.1',
      timestamp: new Date().toISOString(),
      top_factor: 'distance_to_river_km',
    },
    {
      ward_number: 6,
      ward_name: 'Kancharapalem',
      risk_score: 60.1,
      risk_category: 'High',
      alert_color: 'Orange',
      confidence: 0.81,
    ...
    },
    {
      ...
      model_used: 'XGBoost-v2.1',
      timestamp: new Date().toISOString(),
      top_factor: 'elevation_m',
    },
    {
      ward_number: 11,
      ward_name: 'Seethammadhara',
      risk_score: 30.5,
      risk_category: 'Low',
      alert_color: 'Green',
      confidence: 0.88,
  ...
  useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return {
          high_risk_count: 8,
          zones: MOCK_DASHBOARD.ward_predictions.filter(
            (w) => w.risk_score >= 60,
          ),
        };
      }
  ...
  useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return {
          total_wards: 15,
          predictions: MOCK_DASHBOARD.ward_predictions,
        };
      }
    },
    refetchInterval: 60_000,
