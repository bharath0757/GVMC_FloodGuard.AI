...
export declare const useAIDashboardSummary: () => import('@tanstack/react-query').UseQueryResult<
  NoInfer<DashboardSummary>,
  Error
>;
export declare const useAIHighRiskZones: () => import('@tanstack/react-query').UseQueryResult<
  any,
  Error
>;
export declare const useAIWardPredictions: () => import('@tanstack/react-query').UseQueryResult<
  any,
  Error
>;
export declare const useAIPredictRisk: () => import('@tanstack/react-query').UseMutationResult<
  RiskPrediction,
  Error,
  {
    ward_number: number;
  ...
  unknown
>;
export declare const useAIRecommendShelter: () => import('@tanstack/react-query').UseMutationResult<
  ...
  unknown
>;
export declare const useAISafeRoute: () => import('@tanstack/react-query').UseMutationResult<
  SafeRoute,
  Error,
  {
    start_ward: string;
