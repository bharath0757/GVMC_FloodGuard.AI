...
async def high_risk_zones():
    ...
    return JSONResponse(content=_safe({
        ...
        "zones": zones,
        "alert_summary": {
            "critical": len([z for z in zones if z["risk_category"] == "Critical"]),
...
@router.get("/dashboard-summary", summary="AI-powered dashboard summary for all 15 wards")
...
@router.get("/explanations/{prediction_id}", summary="Get SHAP explanations for a prediction")
