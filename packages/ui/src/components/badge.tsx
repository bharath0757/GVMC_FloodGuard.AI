  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 select-none',
  {
    variants: {
      variant: {
        ...
        risk_very_low: 'border-emerald-500/30 bg-emerald-500/15 text-emerald-600 dark:text-emerald-400',
        risk_low: 'border-lime-500/30 bg-lime-500/15 text-lime-600 dark:text-lime-400',
        risk_medium: 'border-amber-500/30 bg-amber-500/15 text-amber-600 dark:text-amber-400',
        risk_high: 'border-orange-500/30 bg-orange-500/15 text-orange-600 dark:text-orange-400',
        risk_critical: 'border-red-500/40 bg-red-500/20 text-red-600 dark:text-red-400 animate-pulse',
      },
    },
    defaultVariants: {
      variant: 'default',
